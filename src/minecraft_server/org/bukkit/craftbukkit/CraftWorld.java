...
public class CraftWorld extends LBWorld {
    ...
    public boolean unloadChunk(int x, int z, boolean save, boolean safe) {
        ...
        net.minecraft.src.Chunk chunk = world.chunkProviderServer.getOrCreateChunk(x, z);
    ...
    public boolean loadChunk(int x, int z, boolean generate) {
        ...
        world.chunkProviderServer.unloadQueue.remove(x, z);
        net.minecraft.src.Chunk chunk = (net.minecraft.src.Chunk) world.chunkProviderServer.chunks.get(x, z);
    ...
    public org.bukkit.entity.Item dropItem(Location loc, ItemStack item) {
        net.minecraft.src.ItemStack stack = new net.minecraft.src.ItemStack(
                item.getTypeId(),
                item.getAmount(),
                item.getDurability()
        );
