...
public class LBFurnace extends LBBlockState implements Furnace {
    ...
    public LBFurnace(LBWorld w, Block b) {
        super(w, b);
        this.entity = (TileEntityFurnace) w.getWorldServer().getTileEntity(b.getX(), b.getY(), b.getZ());
    }
    ...
    public Inventory getInventory() {
        return new LBInventory((IInventory) world.getWorldServer().getTileEntity(this.getX(), this.getY(), this.getZ()));
    }
}
